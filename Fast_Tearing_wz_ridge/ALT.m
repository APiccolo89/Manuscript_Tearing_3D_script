...
oceanic_stratigraphy.phases = [phases.Ph_sed_oc(1),phases.Ph_OC(1),phases.Ph_OLt(1)];
oceanic_stratigraphy.Tk     = [0.0,-2.0,-9.0, -100.0];
oceanic_stratigraphy2.phases = [phases.Ph_sed_oc(1),phases.Ph_OC2(1),phases.Ph_OLt2(1)];
oceanic_stratigraphy2.Tk     = [0.0,-2.0,-9.0, -100.0];
...
BG2.W = Wy/2; 
BG2.L = Lx; 
BG2 = BG2.compute_coordinate_boundary_composite; 
...
Thermal_TypeOcean.v_spreading = convert_Age_velocity(5,2);
Thermal_TypeOcean.Ridge_position = [nan,min(Gr.y_g)]; %Ridge is at the rear end of the model 

Thermal_TypeOcean2 = Thermal_Type;
Thermal_TypeOcean2.Age = convert_Age_velocity(30,1); 
Thermal_TypeOcean2.Type = 'Ridge';
Thermal_TypeOcean2.v_spreading = convert_Age_velocity(-5,2);
Thermal_TypeOcean2.Ridge_position = [nan,min(Gr.y_g)]; %Ridge is at the rear end of the model 
% 
...
%==========================================================================
Terranes = struct('Ocean_BG',Ocean_BG,'Ocean_BG2',Ocean_BG2,'Ocean_OG',Ocean_OG,'Continent1',Continent1,'Continent2',Continent2,'Trench',T);%,'T',T);
%==========================================================================
TA = cputime; 
wsx=20;
wsy=20;
