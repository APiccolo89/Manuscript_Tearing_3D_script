...
Ocean_BG2.name = 'Ocean Background2';
Ocean_BG2.Boundary = BG2; 
Ocean_BG2.Stratigraphy = oceanic_stratigraphy2;
Ocean_BG2.Thermal_information = Thermal_information;
Ocean_BG2.Thermal_type = Thermal_TypeOcean2;
%==========================================================================
T.Boundary = C2;
T.Boundaries_list = {'B'}; 
...
T.length_continent = {[120,20],'linear'};
T.prism_depth = -70; 
...
%==========================================================================
Terranes = struct('Ocean_BG',Ocean_BG,'Ocean_BG2',Ocean_BG2,'Continent1',Continent1,'Continent2',Continent2,'Trench',T);%,'T',T);
%==========================================================================
TA = cputime; 
