...
T.tk_WZ    = 40;   % thickness of the weak zone
...
phases.Ph_OLt2 = [20,3367.957866] ;% Ocean Lithosphere 
phases.Ph_OC2  = [19,3367.957866]   ;%place holder
% List of terranes 
...
f_c2_handle = @(x) parabolic_margin(-750.0,0.0,70,x);
...
%% Oceanic plate 
 ...
 Oceanic_Plate.x_lim = [-750.0,750.0]; 
...
function [Layout,arc_angleS] = find_slab_(A,Slab,type,Terranes)
%=========================================================================
...
[Layout,~] = find_slab_(A,Terranes.Trench_properties,'Slab',Terranes);
% Set the temperature
