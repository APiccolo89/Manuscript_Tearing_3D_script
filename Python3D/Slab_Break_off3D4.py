...
Test_Name =['T1_AV1_v3_10000','T1_AV1_v5_10000','T1_AV1_v10_10000','T1_AV2_v3_10000','T1_AV2_v10_10000']
    ...
    if os.path.isdir(l_):
        ...
        try:
            ...
            if not os.path.isdir(ptsave_DB):
                os.mkdir(ptsave_DB)
            _run_script_visualization(ptsave,Folder,L,l_,ptsave_DB,'Shear_Heating')
        except:
